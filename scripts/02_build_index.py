...
# FULL CORRECTED COORDINATES (50 CERCLES)
CAPITAL_COORDS = {
    'abeibara': (19.0, 2.0), 'ansongo': (15.67, 0.50), 'bafoulabe': (13.81, -10.82),
    'bamako': (12.65, -8.00), 'banamba': (13.55, -7.45), 'bandiagara': (14.35, -3.61),
    'bankass': (14.08, -3.52), 'baraoueli': (13.37, -6.90), 'bla': (13.48, -5.77),
    'bougouni': (11.42, -7.48), 'bourem': (16.97, -0.36), 'diema': (14.53, -9.18),
    'dire': (16.27, -3.40), 'dioila': (12.70, -6.80), 'djenne': (13.91, -4.56),
    'douentza': (15.00, -2.95), 'gao': (16.27, -0.04), 'goundam': (16.41, -3.67),
    'gourma-rharous': (16.88, -1.93), 'kadiolo': (10.57, -5.70), 'kangaba': (11.93, -8.42),
    'kati': (12.75, -8.07), 'kayes': (14.45, -11.44), 'kenieba': (12.83, -11.23),
    'kidal': (18.44, 1.41), 'kita': (13.03, -9.49), 'kolokani': (13.55, -8.03),
    'kolondieba': (11.08, -6.88), 'koro': (14.08, -3.08), 'koulikoro': (12.86, -7.56),
    'koutiala': (12.39, -5.47), 'macina': (14.11, -5.35), 'menaka': (15.92, 2.40),
    'mopti': (14.49, -4.19), 'nara': (15.17, -7.28), 'niafunke': (15.93, -3.98),
    'nioro': (15.23, -9.58), 'niono': (14.25, -5.98), 'san': (13.30, -4.90),
    'segou': (13.45, -6.27), 'sikasso': (11.33, -5.67), 'tenenkou': (14.52, -4.92),
    'tessalit': (20.20, 0.98), 'tin-essako': (19.47, 2.47), 'tombouctou': (16.77, -3.00),
    'tominian': (13.28, -4.58), 'yanfolila': (11.18, -8.15), 'yelimane': (15.13, -10.57),
    'yorosso': (12.37, -4.78), 'youwarou': (15.25, -4.18)
}
...
# ACLED
conflict_stats = {c: {'events': 0} for c in official_cercles_norm}
...
for k, p in pop_lookup.items():
    ...
    final.append({'cercle': p['display_name'], 'region': p['region'], 'lat': l, 'lng': ln, 'total_schools': s['total'], 'closed_schools': s['closed'], 'pct_closed': round(p_cl, 2), 'total_conflict_events': c['events'], 'population': p['pop'], 'events_per_100k': round(e_100k, 2)})
...
with open('data/clean/mali_map_data.csv', 'w', newline='', encoding='utf-8') as f:
    ...
    dw.writeheader()
    for r in final: 
        dw.writerow({'cercle':r['cercle'],'region':r['region'],'lat':r['lat'],'lng':r['lng'],'edi':r['EDI_score'],'risk':r['risk_tier'],'total_schools':r['total_schools'],'closed_schools':r['closed_schools'],'pct_closed':r['pct_closed'],'total_conflict_events':r['total_conflict_events'],'events_per_100k':r['events_per_100k'],'population':r['population']})

print("Success: Summary and Map Data regenerated with fixed coordinates.")
